...
- **기준 코드**: `main` 브랜치, 커밋 `1ba5a1c` — **전 문서 공통** (CN-002 에 의해 `a13b9a8` → `1ba5a1c`)
- **작성 언어**: 한국어. 식별자·API 경로만 영문.
- **상태**: `10-착수` 3종 · `00-index` 3종 · `20-요구사항` 1종 완료. 나머지 폴더는 미착수.
...
├── 00-index/              ✅ 마스터인덱스 · 산출물 대장 · 변경이력
├── 10-착수/               ✅ 과업지시서 · 범위기술서 · 과제-상세-안내
├── 20-요구사항/           ✅ 요구사항정의서 (요구사항 추적표는 미착수)
...
> ⚠️ **CN-004 에 의해 이 절의 방침이 변경됩니다.**
> 과제 요건 A-2·A-3 에 의해 학습 내용 색인이 요건 자체가 되었습니다.
> `data/samples/` 와 IA 학습 문서를 10단원으로 재구성해 색인하되,
> `docs/` 산출물 문서는 여전히 색인하지 않습니다.
> 상세는 [변경이력 CN-004](00-index/변경이력.md) 참조.
